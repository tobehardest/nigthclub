...
func (l *AddRoomLogic) AddRoom(req *types.AddRoomReq) (resp *types.AddMerchantResp, err error) {
	...
	merchantKey := globalkey.RoomKey + merchantId
	err = l.svcCtx.RedisClient.SetCtx(l.ctx, merchantKey, string(roomBytes))
	if err != nil {
